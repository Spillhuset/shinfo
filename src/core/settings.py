...
INSTALLED_APPS = [
  ...
  'apps.shinfo.apps.SHinfoConfig',
  'apps.content_garage.apps.ContentGarageConfig',
  'apps.device_and_screen_management.apps.DeviceAndScreenManagementConfig',
  'apps.schedules.apps.ScheduleConfig',
